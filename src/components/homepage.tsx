    ...
    <div className="flex flex-col min-h-dvh items-center">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6 grid gap-12">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 id="#about" className="text-3xl font-bold tracking-tighter sm:text-5xl">Effortless Expense Tracking</h2>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        ...
        <nav className="sm:ml-auto flex gap-4 sm:gap-6">
          ...
          <Link href="https://github.com/tylerbert31" target="_blank" className="text-xs hover:underline underline-offset-4" prefetch={false}>
            Github
          </Link>
          <Link href="https://www.linkedin.com/in/tyler-bert-baring-156464270/?original_referer=" target="_blank" className="text-xs hover:underline underline-offset-4" prefetch={false}>
            LinkedIn
          </Link>
        </nav>
      </footer>
